...
@Autonomous(name="FTC2018_robot1_Auto_Blue_1", group ="FTC 2018")

public class FTC2018_robot1_Auto_Blue_1 extends LinearOpMode {
    ...
    final public double LocalSpeed = .15;
    ...
    public void initial(){
        ...
        robot.LArm.setPosition(robot.LArmClose);
    ...
    @Override public void runOpMode() {
        ...
        sleep(1000);
        if (robot.ColourSensorL.getLightDetected() > 0.3){
            jewel = "Red";
        }
        else {
            jewel = "Blue";
        ...
        telemetry.update();
            ...
            if (jewel == "Red") {
                SetDistanceToGo(3,0.3,1,-1,1,-1);
                robot.LArm.setPosition(robot.LArmClose);
                sleep(1500);
                SetDistanceToGo(3,.5,-1,1,-1,1);
            }
            else if (jewel == "Blue") {
                SetDistanceToGo(3,0.3,-1,1,-1,1);
                robot.LArm.setPosition(robot.LArmClose);
