...
@Autonomous(name="FTC_2018_SZ_Robot2_Red_2", group ="FTC 2018")

public class FTC_2018_SZ_Robot2_Red_2 extends LinearOpMode {
    ...
    public void Kick_Jewel() {
        ...
        dataUpper = robot.ColorUpperL.getLightDetected();
        dataLower = robot.ColorLowerL.getLightDetected();
