...
@Autonomous(name="FTC_2018_SZ_Robot1_Auto_Blue1", group ="FTC 2018")

public class FTC_2018_SZ_Robot2_Auto_Blue1 extends LinearOpMode {
...
//trs
    ...
    {
        SetDistanceToGo(Distance*2.60, Power,1,-1,-1,1);
    }
    ...
    public void lf(double Distance, double Power)
    {
        SetDistanceToGo(Distance*2.60, Power,1,0,0,1);
    }
